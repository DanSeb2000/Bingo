 ...
 * I see that you decided to decompile or look at the github of this plugin for wharever reason,
 * maybe see what's inside, maybe to stole something or see what's wrong with my code to tell
 * everyone that this code is very basic/newie to be published here.
 *
