...
public enum UniversalMaterial {
    ...
    public Material getType() {
        if (!this.loaded) {
            try {
                this.material = Material.valueOf(getTypeName());
    ...
    private String getTypeName() {
        return (Core.getVersion() < 13) ? this.name8 : this.name13;
    }

    public short getData() {
        return (Core.getVersion() < 13) ? this.id8 : 0;
    }
    ...
    public static boolean isLog(Material material) {
        return (material
                .equals(ACACIA_LOG.getType()) || material
                .equals(BIRCH_LOG.getType()) || material
                .equals(DARK_OAK_LOG.getType()) || material
                .equals(JUNGLE_LOG.getType()) || material
                .equals(OAK_LOG.getType()) || material
                .equals(SPRUCE_LOG.getType()));
    }

    public static boolean isLeaves(Material material) {
        return (material
                .equals(ACACIA_LEAVES.getType()) || material
                .equals(BIRCH_LEAVES.getType()) || material
                .equals(DARK_OAK_LEAVES.getType()) || material
                .equals(JUNGLE_LEAVES.getType()) || material
                .equals(OAK_LEAVES.getType()) || material
                .equals(SPRUCE_LEAVES.getType()));
    }
    ...
    public static boolean isCorrectTool(Material block, Material tool) {
        switch (block) {
            ...
            case GOLD_ORE:
            case REDSTONE_ORE:
                return (tool == Material.DIAMOND_PICKAXE || tool == GOLDEN_PICKAXE
                        .getType() || tool == Material.IRON_PICKAXE);
            case IRON_ORE:
                return (tool == Material.DIAMOND_PICKAXE || tool == GOLDEN_PICKAXE
                        .getType() || tool == Material.IRON_PICKAXE || tool == Material.STONE_PICKAXE);
            case COAL_ORE:
                return (tool == Material.DIAMOND_PICKAXE || tool == GOLDEN_PICKAXE
                        .getType() || tool == Material.IRON_PICKAXE || tool == Material.STONE_PICKAXE || tool == WOODEN_PICKAXE

                        .getType());
            case SAND:
            case GRAVEL:
                return (tool == WOODEN_SHOVEL.getType() || tool == STONE_SHOVEL
                        .getType() || tool == IRON_SHOVEL
                        .getType() || tool == GOLDEN_SHOVEL
                        .getType() || tool == DIAMOND_SHOVEL
                        .getType());
        }
        return false;
    }
